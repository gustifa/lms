...
<!-- ================================
       START FUNFACT AREA
================================= -->
<section class="overflow-hidden text-center funfact-area pt-20px pb-80px dot-bg">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        <div class="text-center cta-content-wrap">
            ...
            <div class="cat-btn-box mt-28px">
                <a href="sign-up.html" class="btn theme-btn">Get Started <i class="ml-1 la la-arrow-right icon"></i></a>
            </div><!-- end cat-btn-box -->
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="pb-5 about-content">
                    ...
                    <div class="btn-box">
                        <a href="about.html" class="btn theme-btn">Learn More <i class="ml-1 la la-arrow-right icon"></i></a>
                    </div><!-- end btn-box -->
                    ...
                    <div class="card-body">
                        ...
                        <form method="post">
                            ...
                            <div class="pt-2 btn-box">
                                <button class="btn theme-btn" type="submit">Apply Now <i class="ml-1 la la-arrow-right icon"></i></button>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
...
<section class="overflow-hidden text-center client-logo-area section-padding position-relative">
    ...
    <div class="container">
        <div class="section-heading">
            <h5 class="mb-2 ribbon ribbon-lg">Our partners</h5>
        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="text-center card card-item hover-s">
                    <div class="card-body">
                        <img src="{{asset('frontend/images/img-loading.png')}}" data-src="{{asset('frontend/images/small-img-2.jpg')}}" alt="card image" class="rounded-full img-fluid lazy">
                        ...
                        <div class="btn-box mt-20px">
                            <a href="become-a-teacher.html" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="mr-1 la la-user"></i>Start Teaching</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="text-center card card-item hover-s">
                    <div class="card-body">
                        <img src="{{asset('frontend/images/img-loading.png')}}" data-src="{{asset('frontend/images/small-img-3.jpg')}}" alt="card image" class="rounded-full img-fluid lazy">
                        ...
                        <div class="btn-box mt-20px">
                            <a href="admission.html" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="mr-1 la la-file-text-o"></i>Start Learning</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="text-center card card-item hover-s">
                    <div class="card-body">
                        <img src="{{asset('frontend/images/img-loading.png')}}" data-src="{{asset('frontend/images/small-img-4.jpg')}}" alt="card image" class="rounded-full img-fluid lazy">
                        ...
                        <div class="btn-box mt-20px">
                            <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-white lh-30"><i class="mr-1 la la-briefcase"></i>Get aduca for business</a>
                        </div><!-- end btn-box -->
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
...
======================================-->
<section class="overflow-hidden subscriber-area pt-60px pb-60px bg-gray position-relative">
    <span class="stroke-shape stroke-shape-1"></span>
    <span class="stroke-shape stroke-shape-2"></span>
    <span class="stroke-shape stroke-shape-3"></span>
    <span class="stroke-shape stroke-shape-4"></span>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="py-4 section-heading">
                    <h5 class="mb-2 ribbon ribbon-lg">Newsletter</h5>
                    <h2 class="mb-1 section__title">Subscribe to newsletter</h2>
            ...
            <div class="ml-auto col-lg-5">
                <form method="post" class="subscriber-form">
                    <div class="input-group">
                        <input type="email" name="email" class="pl-3 form-control form--control" placeholder="Enter email address">
                        <div class="input-group-append">
                            <button class="btn theme-btn" type="button">Subscribe <i class="ml-1 la la-arrow-right icon"></i></button>
                        </div>
                    </div>
                    <p class="mt-1 fs-14">
                        <i class="mr-1 la la-lock"></i>Your information is safe with us! unsubscribe anytime.
                    </p>
                </form>
            </div><!-- end col-lg-6 -->
        </div><!-- end row -->
    ...
    <div id="tooltip_content_1">
        <div class="card card-item">
            <div class="card-body">
                ...
                <h5 class="pb-1 card-title"><a href="course-details.html">The Business Intelligence Analyst Course 2021</a></h5>
                <div class="pb-1 d-flex align-items-center">
                    <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                    <p class="text-success fs-14 font-weight-medium">Updated<span class="pl-1 font-weight-bold">November 2020</span></p>
                </div>
                <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center fs-14">
                    <li>23 total hours</li>
                    <li>All Levels</li>
                </ul>
                <p class="pt-1 card-text fs-14 lh-22">The skills you need to become a BI Analyst - Statistics, Database theory, SQL, Tableau – Everything is included</p>
                <ul class="py-3 generic-list-item fs-14">
                    <li><i class="mr-1 text-black la la-check"></i> Become an expert in Statistics, SQL, Tableau, and problem solving</li>
                    <li><i class="mr-1 text-black la la-check"></i> Boost your resume with in-demand skills</li>
                    <li><i class="mr-1 text-black la la-check"></i> Gather, organize, analyze and visualize data</li>
                </ul>
                <div class="d-flex justify-content-between align-items-center">
...
<div class="tooltip_templates">
    <div id="tooltip_content_2">
        <div class="card card-item">
            <div class="card-body">
                <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                <h5 class="pb-1 card-title"><a href="course-details.html">Ultimate Adobe Photoshop Training: From Beginner to Pro</a></h5>
                <div class="pb-1 d-flex align-items-center">
                    <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                    <p class="text-success fs-14 font-weight-medium">Updated<span class="pl-1 font-weight-bold">November 2020</span></p>
                </div>
...
<div class="tooltip_templates">
    <div id="tooltip_content_3">
        <div class="card card-item">
            <div class="card-body">
                <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                <h5 class="pb-1 card-title"><a href="course-details.html">The Complete WordPress Website Business Course</a></h5>
                <div class="pb-1 d-flex align-items-center">
                    <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                    <p class="text-success fs-14 font-weight-medium">Updated<span class="pl-1 font-weight-bold">November 2020</span></p>
                </div>
...
<div class="tooltip_templates">
    <div id="tooltip_content_4">
        <div class="card card-item">
            <div class="card-body">
                <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                <h5 class="pb-1 card-title"><a href="course-details.html">The Ultimate Drawing Course - Beginner to Advanced</a></h5>
                <div class="pb-1 d-flex align-items-center">
                    <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                    <p class="text-success fs-14 font-weight-medium">Updated<span class="pl-1 font-weight-bold">November 2020</span></p>
                </div>
...
<div class="tooltip_templates">
    <div id="tooltip_content_5">
        <div class="card card-item">
            <div class="card-body">
                <p class="pb-2 card-text">By <a href="teacher-detail.html">Jose Portilla</a></p>
                <h5 class="pb-1 card-title"><a href="course-details.html">The Complete Digital Marketing Course - 12 Courses in 1</a></h5>
                <div class="pb-1 d-flex align-items-center">
                    <h6 class="mr-2 ribbon fs-14">Bestseller</h6>
                    <p class="text-success fs-14 font-weight-medium">Updated<span class="pl-1 font-weight-bold">November 2020</span></p>
                </div>
