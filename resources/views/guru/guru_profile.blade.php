                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center d-flex flex-column align-items-center">
                                <img src="{{(!empty($profileData->photo)) ? url('upload/guru_images/'.$profileData->photo): url('upload/no_image.jpg')}}" alt="Guru" class="p-1 rounded-circle bg-primary" width="110">
                                <div class="mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id ="showImage"src="{{(!empty($profileData->photo)) ? url('upload/guru_images/'.$profileData->photo): url('upload/no_image.jpg')}}" alt="Admin" class="p-1 rounded-circle bg-primary" width="80">
                                </div>
                            </div>
