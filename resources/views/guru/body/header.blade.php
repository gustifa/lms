    ...
    <div class="topbar d-flex align-items-center">
        <nav class="gap-3 navbar navbar-expand">
              ...
              <div class="top-menu ms-auto">
                <ul class="gap-1 navbar-nav align-items-center">
                    ...
                    <li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="avascript:;" data-bs-toggle="dropdown"><img src="{{ asset('backend/assets//images/county/02.')}}" width="22" alt="">
                        </a>
            ...
            <div class="px-3 user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('guru.profile')}}"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item d-flex align-items-center" href="{{route('guru.change.password')}}"><i class="bx bx-cog fs-5"></i><span>Change Password</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{url('guru/logout')}}"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
